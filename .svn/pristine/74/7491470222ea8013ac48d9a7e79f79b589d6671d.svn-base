...
//{
    ...
    //{
        require("./styles/SignupCorePanelVcc_style.styl");
    //}
    
    //    Equated dependencies.
    //{
        aa.tmplt = require("./SignupCorePanelVcc_tmplt.html");
        aa.LinkFncClass = require("./SignupCorePanelVcc_LinkFncClass.js");
        aa.CtrlClass = require("./SignupCorePanelVcc_CtrlClass.js");
    //}
