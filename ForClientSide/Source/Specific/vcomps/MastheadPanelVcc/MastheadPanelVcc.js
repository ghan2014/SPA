...
//{
	...
	//{
		aa.style = require("./styles/MastheadPanelVcc_style.styl");
	//}
	
	//	Equated dependencies.
	//{
		aa.tmplt = require("./MastheadPanelVccLinkTmplt.html");
		aa.LinkFncClass = require("./MastheadPanelVccLinkFncClass.js");
		aa.CtrlClass = require("./MastheadPanelVccCtrlClass.js");
	//}
