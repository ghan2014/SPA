 ...
 * *********************************************************************
 * *********************************************************************
 * File: SharePanelVcc_CtrlClass.js
 * *********************************************************************
 * *********************************************************************
 */
module.exports = (function() {
	...
	//	Class properties.
	// {
		aa.myVcName = "SharePanelVcc";
		aa.myClassName = "SharePanelVcc_CtrlClass";
		...
		aa.myConstructor = function (scopeNg, stateNg, stateParamsNg, timeoutNg, mediatorService, stationsService) {
			console.dog(">>> SharePanelVcc_CtrlClass held as MyClass");
	...
	//{	
		...
		p._setup = async function(goDude) {
			...
			console.dog('>>> SharePanelVcc_CtrlClass._setup - scopeNg ', that.scopeNg);
		...
		p._setupStndDatas = async function() {
			...
			console.dog(">>> SharePanelVcc_CtrlClass - that.scopeNg: ", that.scopeNg);
